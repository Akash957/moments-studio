    ...
    <div class="container py-4">
        ...
        <div class="packages-wrapper">
            ...
            <div class="package-card-item {{ $package->is_popular ? 'popular' : '' }}" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                ...
                {{-- Banner Image --}}
                <div class="package-header-banner" style="cursor:pointer;" @click="openPackageModal({{ $pkgJson }})">
                ...
                {{-- Title & Tagline --}}
                <h3 class="package-title font-serif" style="cursor:pointer;" @click="openPackageModal({{ $pkgJson }})">{{ $package->name }}</h3>
                @if($package->tagline)
                ...
                {{-- Action Row --}}
                <div class="mb-3">
                    <button type="button" class="btn btn-outline-gold btn-sm w-100 fw-bold py-2" @click="openPackageModal({{ $pkgJson }})">
                        <i class="fas fa-eye me-1"></i> Quick View Full Deliverables
                    </button>
                </div>
                ...
                <div class="mt-auto d-flex flex-column gap-2">
                    <a href="{{ route('packages.show', $package->slug) }}" class="btn-package-action">
                        <span>View Package Details</span> <i class="fas fa-arrow-right"></i>
                    </a>
                    <a href="{{ route('booking.create', ['package_id' => $package->id]) }}" class="btn btn-outline-gold w-100 py-2 fw-bold text-center">
                        <i class="fas fa-calendar-check me-1"></i> Reserve Date
                    </a>
                </div>
            </div>
