...
<div class="card card-outline card-warning">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-edit mr-2"></i> Edit Role: {{ $role->name }}</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
            ...
            <h5 class="text-gold border-bottom pb-2 mb-3"><i class="fas fa-key mr-2"></i> Update Group Permissions</h5>
            <div class="row">
                    ...
                    <div class="card bg-dark text-white border-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mb-2">
                                <input type="checkbox" name="permissions[]" value="{{ $p }}" class="form-check-input" id="perm_{{ $p }}" {{ in_array($p, $rolePermissions) ? 'checked' : '' }}>
            ...
            <hr>
            <button type="submit" class="btn btn-gold"><i class="fas fa-save mr-1"></i> Update Role</button>
