...
class SettingController extends Controller
{
    public function index()
    {
        ...
        if (Setting::get('site_name') !== 'Love Studios') {
            Setting::set('site_name', 'Love Studios');
            Setting::set('site_tagline', 'Capturing Eternal Love & Special Moments');
            Setting::set('site_email', 'info@lovestudios.in');
        }
